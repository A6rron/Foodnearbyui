...
export function Hero({ locationStatus, onLocationClick }: HeroProps) {
  return (
    <div className="bg-gradient-to-b from-gray-900 to-[#0f172a] py-8 sm:py-10 md:py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 className="text-white mb-3 sm:mb-4 text-xl sm:text-2xl md:text-3xl font-semibold">Find Free Food Near You</h1>
